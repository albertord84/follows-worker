        ...
        <div style="text-align: center;">
            <div style="max-width: 580px; font-family: Arial, Helvetica, sans-serif; font-size: 11px;">
                <div style="padding:24px 16px; border-top-left-radius:15px; border-top-right-radius:15px; text-align:center; background-color:#CBD640;">
                    ...
                    <h1 S>Verificação de autenticidade</h1>
                </div>
                <div style="padding:60px; background-color:#F5F8F6">
                    <div>
                        <p>Olá <strong><?php echo urldecode($_GET["username"]);?></strong>,</p>
                        <p>Você acaba de fazer o primeiro passo para se cadastrar na nossa ferramenta.</p>
                        <p>Seu nome de usuário no nosso sistema é: <strong><?php echo $_GET["instaname"]; ?></strong></p>
                        <p>Para concluir o processo de validação do seu email, por favor, utilize o seguinte código de 4 dígitos e continue com a assinatura:</p>
