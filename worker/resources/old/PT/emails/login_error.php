...
<html>
    ...
    <body>
        <div style="width: 640px; font-family: Arial, Helvetica, sans-serif; font-size: 11px;">
            ...
            <p>Lembre-se: você deve ter mesmo nome de usuário e senha para ambos, Instagram e nosso <a href="https://www.dumbu.pro/follows-worker/src/">sistema</a>.
            <p>Você só precisa fazer o login no Dumbu com um nome de usuário e senha válidos e iguais ao seu Instagram.!</p>
            <p>Por favor, verifique suas credenciais de login no instagram e nosso <a href="https://www.dumbu.pro/follows-worker/src/">sistema</a> 
