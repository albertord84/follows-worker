...
class Clients_model extends CI_Model {
  function __construct() {
	...
	function save ($plane_id, $credit_card_number, $credit_card_status_id, $credit_card_cvc, $credit_card_name, $credit_card_exp_month, $credit_card_exp_year, $pay_day,
				   ...
				   $last_access, $cookies, $utm_source, $unfollow, $observation, $unfollow_total, $like_first, $paused, $ticket_peixe_urbano, $ticket_peixe_urbano_status_id, 
				   $purchase_counter, $retry_payment_counter, $purchase_access_token, $ticket_access_token, $retry_registration_counter, $proxy, $mundi_to_vindi) {
	...
	function update ($user_id, $plane_id, $credit_card_number, $credit_card_status_id, $credit_card_cvc, $credit_card_name, $credit_card_exp_month, $credit_card_exp_year, 
					 ...
					 $foults, $last_access, $cookies,$utm_source, $unfollow, $observation, $unfollow_total, $like_first, $paused, $ticket_peixe_urbano, $ticket_peixe_urbano_status_id, 
					 $purchase_counter, $retry_payment_counter, $purchase_access_token, $ticket_access_token, $retry_registration_counter, $proxy, $mundi_to_vindi){
		$this->plane_id = $plane_id;
        $this->credit_card_number = $credit_card_number;
        $this->credit_card_status_id = $credit_card_status_id;
