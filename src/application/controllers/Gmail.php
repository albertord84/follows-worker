...
class Gmail extends CI_Controller {
    ...
    public function send_client_payment_success() {
        ...
        $result = $Gmail->send_client_payment_success($useremail, $username, $instaname, $instapass, $site, $atendent_email);
        echo json_encode($result);
    }
    ...
    public function test_emails_robots() {
        ...
        $result = $Gmail->send_client_login_error($useremail, $username, $instaname, $instapass);
        echo json_encode($result);
    }
